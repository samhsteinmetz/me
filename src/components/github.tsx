...
/* From Uiverse.io by Ashe-T */
  <button
    ...
    className="group p-2 rounded-md drop-shadow-xl bg-gradient-to-r from-gray-800 to-black text-white font-semibold hover:translate-y-2 transition-all duration-500 hover:from-[#331029] hover:to-[#310413]"
  >
    <svg
      className="w-5"
      viewBox="0 0 15 15"
